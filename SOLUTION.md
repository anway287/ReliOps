...
I used Claude for tab-completion on repetitive patterns things like `StyleSheet.create` blocks, switch-case exhaustiveness, and slice boilerplate. All architecture decisions, data modelling, selector design, and product thinking were done by me.
